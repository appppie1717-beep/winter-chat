    ...
    with tab2:
        ...
        with st.container(height=500):
            ...
            * **[23:30] 호감도 누적 티어제 및 배드엔딩 시스템:** 누적 점수에 따라 츤데레에서 썸, 그리고 메가데레로 성격이 진화하며, 마이너스 50점 달성 시 영구 차단되는 배드엔딩이 추가되었습니다.
            ...
            ---
            **[ v2.1.3 ] 2026.03.30 (월)**
            * **[21:30] 기억 리셋 안전장치(팝업) 추가:** 실수로 버튼을 눌러 소중한 추억이 날아가는 것을 방지하는 경고창 적용.

            ---
            **[ v2.1.2 ] 2026.03.30 (월)**
            * **[21:30]  UI 잘림 버그 복구:** 상단 레이아웃이 잘려서 안 보이던 현상 해결.
            ...
            * **[20:15] 자동 롤링 메모리 버그 수정:** 대화 10번마다 백그라운드에서 과거 기억 요약 압축.
            ...
            ---
            **[ v1.7.0 ] 2026.03.30 (월)**
            * **[19:10] 철벽 방어 시스템 (가드레일):** 불건전한 대화 시 봇이 정색하며 철벽을 치는 윤리 필터 완벽 적용.
